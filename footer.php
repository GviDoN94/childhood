                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('instagram', 23); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('youtube', 23); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('facebook', 23); ?>" class="footer__social-item">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:<?php the_field('phone_1', 23); ?>"><?php the_field('phone_1', 23); ?></a>
                                    <a href="tel:<?php the_field('phone_2', 23); ?>"><?php the_field('phone_2', 23); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
                                <address><?php the_field('address', 23); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
